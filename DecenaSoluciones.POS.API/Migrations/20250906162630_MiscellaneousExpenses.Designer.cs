...
namespace DecenaSoluciones.POS.API.Migrations
{
    ...
    [Migration("20250906162630_MiscellaneousExpenses")]
    partial class MiscellaneousExpenses
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DecenaSoluciones.POS.API.Models.InventoryEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("InventoryEntryTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("InventoryEntryTypeId");
            ...
            modelBuilder.Entity("DecenaSoluciones.POS.API.Models.InventoryEntryDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DecenaSoluciones.POS.API.Models.InventoryEntryType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("InventoryEntryTypes");
                });

            modelBuilder.Entity("DecenaSoluciones.POS.API.Models.MiscellaneousExpense", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DecenaSoluciones.POS.API.Models.Provider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DecenaSoluciones.POS.API.Models.InventoryEntry", b =>
                {
                    ...
                    b.HasOne("DecenaSoluciones.POS.API.Models.InventoryEntryType", "InventoryEntryType")
                        .WithMany()
                        .HasForeignKey("InventoryEntryTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DecenaSoluciones.POS.API.Models.Provider", "Provider")
                        .WithMany()
                        .HasForeignKey("ProviderId");

                    b.Navigation("Company");

                    b.Navigation("InventoryEntryType");
            ...
            modelBuilder.Entity("DecenaSoluciones.POS.API.Models.InventoryEntryDetail", b =>
                {
                    ...
                    b.HasOne("DecenaSoluciones.POS.API.Models.InventoryEntry", "InventoryEntry")
